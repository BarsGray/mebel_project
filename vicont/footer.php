	...
	<div class="container">
		<div class="footer_block">
			...
			<div class="footer_item">
				...
				<a href="tel:+<?php echo preg_replace('/[^0-9]/', '', carbon_get_theme_option('crb_phone_number')); ?>" class="footer_details">
					<span class="phone"></span>
					<p><?php echo carbon_get_theme_option('crb_phone_number'); ?></p>
				</a>
				<a href="/kontakty/" class="footer_details">
					<span class="pin"></span>
					<p><?php echo carbon_get_theme_option('crb_address_footer'); ?></p>
				</a>
				<a href="mailto:vikont2100@yandex.ru" class="footer_details">
			...
			<div class="footer_item question">
				...
				<!-- <div class="footer_socials">
					<a href="<?php // echo (carbon_get_theme_option('crb_address_telegram')) ? carbon_get_theme_option('crb_address_telegram') : '#' ?>">
						<img src="<?php // bloginfo('template_url') ?>/img/7fut/telegram(2).png" alt="telegram">
					</a>
					<a href="<?php // echo (carbon_get_theme_option('crb_address_whatsapp')) ? carbon_get_theme_option('crb_address_whatsapp') : '#' ?>">
						<img src="<?php // bloginfo('template_url') ?>/assets/images/footer/whatssapp-big-logo.png" alt="whatssapp">
					</a>
					<a href="<?php // echo (carbon_get_theme_option('crb_address_viber')) ? carbon_get_theme_option('crb_address_viber') : '#' ?>">
						<img src="<?php // bloginfo('template_url') ?>/assets/images/footer/viber(1).png" alt="viber">
					</a>
				</div> -->
...
<!-- Yandex.Metrika counter --> <script type="text/javascript" > (function(m,e,t,r,i,k,a){m[i]=m[i]||function(){(m[i].a=m[i].a||[]).push(arguments)}; m[i].l=1*new Date(); for (var j = 0; j < document.scripts.length; j++) {if (document.scripts[j].src === r) { return; }} k=e.createElement(t),a=e.getElementsByTagName(t)[0],k.async=1,k.src=r,a.parentNode.insertBefore(k,a)}) (window, document, "script", "https://mc.yandex.ru/metrika/tag.js", "ym"); ym(97889470, "init", { clickmap:true, trackLinks:true, accurateTrackBounce:true, webvisor:true }); </script> <noscript><div><img src="https://mc.yandex.ru/watch/97889470" style="position:absolute; left:-9999px;" alt="" /></div></noscript> <!-- /Yandex.Metrika counter -->
