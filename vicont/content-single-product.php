		...
		<table class="table_kbzu">
			...
			<tbody>
				<tr class="table_kbzu_row">
					...
					<td class="table_kbzu_td"><?php // echo carbon_get_post_meta($GLOBALS['id_pro_carrent'], 'crb_product_ccal'); 
																		?></td>
				</tr>
				<tr class="table_kbzu_row">
					<th class="table_kbzu_td_head">Белки</th>
					<td class="table_kbzu_td"><?php // echo carbon_get_post_meta($GLOBALS['id_pro_carrent'], 'crb_product_belki'); 
																		?></td>
				</tr>
				<tr class="table_kbzu_row">
					<th class="table_kbzu_td_head">Жиры</th>
					<td class="table_kbzu_td"><?php // echo carbon_get_post_meta($GLOBALS['id_pro_carrent'], 'crb_product_zhiri'); 
																		?></td>
				</tr>
				<tr class="table_kbzu_row">
					<th class="table_kbzu_td_head">Углеводы</th>
					<td class="table_kbzu_td"><?php // echo carbon_get_post_meta($GLOBALS['id_pro_carrent'], 'crb_product_uglev'); 
																		?></td>
				</tr>
			</tbody>
		</table>
	</div>
	<img class="product_information" src="<?php // bloginfo('template_url'); 
																				?>/assets/images/product/information.svg" alt="information">
</div> -->
<?php endif; ?>
...
<div id="product-<?php the_ID(); ?>" <?php wc_product_class('product_display', $product); ?>>
	...
	<div class="summary entry-summary about_product">
		<!-- <button class="add-to-wishlist-button" data-product-id="<?php // echo get_the_ID(); ?>">
