...
// function add_custom_wishlist_script()
// {
//   <script>
...
//   </script>
// }
// add_action('wp_footer', 'add_custom_wishlist_script');
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      function updateWishlistCount() {
        ...
        let countElement = document.querySelectorAll('.wishlist-count');

        if (count == 0) {
          $('.wishlist-count').attr('style', '');
        } else {
          $('.wishlist-count').attr('style', 'display:flex;');
          // $('.header_top_box .like').append(countElement);
          // countElement.remove();
        }
...
.crb_slider_day_box_complex .cf-complex__groups {
  display: flex;
  gap: 10px;
  flex-wrap: wrap;
}
...
.crb_photos_of_interiors_in_admin div.crb_photos_of_interiors_complex .cf-complex__groups {
  display: flex;
  flex-wrap: wrap;
  gap: 10px;
}
  
.crb_photos_of_interiors_in_admin div.crb_photos_of_interiors_complex .cf-complex__groups>.cf-complex__group--grid{
  min-width: 157px;
}
  </style>';
}
